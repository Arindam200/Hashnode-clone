      ...
      <div className="sm:mt-14 mt-2  md:flex md:p-5">
        ...
        <div className="flex md:w-1/2 gap-5 p-1 sm:p-5">
          ...
          <div>
            ...
            <h2 className="">
              You retain all the rights to your content. Export and download all
              your posts from your dashboard with a single click.
            </h2>
          </div>
        </div>
      </div>
      <div className="mt-1 md:flex md:p-5 gap-2">
        <div className="flex md:w-1/2 gap-5 p-1 sm:p-5">
          ...
          <div>
            ...
            <h2 className="">
              Modify the appearance of your developer blog using our Custom CSS
              feature. Change the font family, font size, primary link colors,
              and more.
            </h2>
          </div>
        </div>
      ...
      <div className="mt-1 md:flex md:p-5 gap-2">
        <div className="flex md:w-1/2 gap-5 p-1 sm:p-5">
          ...
          <div>
            ...
            <h2 className="">
              Publish and backup articles directly on a private or public GitHub
              repo - enabling you to always have control over your content.
            </h2>
          </div>
        </div>
        <div className="flex md:w-1/2 gap-5 p-1 sm:p-5">
