...
import TeamBlogs from "./components/Myfeed/TeamBlogs";
import TrendingArticles from "./components/Myfeed/TrendingArticles";
import WritingChallenges from "./components/Myfeed/WritingChallenges";
import Blogs from "./components/Myfeed/Blogs";

const Myfeed = () => {
  return (
    <div className="w-11/12 md:w-7/12 lg:w-8/12 xl:w-10/12 mx-auto flex justify-center gap-10 lg:pt-10">
      {/* Left Section */}
